...
INSTRUCCIONES = list()
INSTRUCCIONES.append(  CreateInstruccion(id=0, path_video='0_bienvenida.mp4', time=TIEMPO_POR_INSTRUCCION)  )
INSTRUCCIONES.append(  CreateInstruccion(id=1, path_video='1_mojarse_manos.mp4', time=TIEMPO_POR_INSTRUCCION)  )
INSTRUCCIONES.append(  CreateInstruccion(id=2, path_video='2_aplique_jabon.mp4', time=TIEMPO_POR_INSTRUCCION)  )
INSTRUCCIONES.append(  CreateInstruccion(id=3, path_video='3_palma_con_palma.mp4', time=TIEMPO_POR_INSTRUCCION)  )
INSTRUCCIONES.append(  CreateInstruccion(id=4, path_video='5_detras_manos.mp4', time=TIEMPO_POR_INSTRUCCION)  )
INSTRUCCIONES.append(  CreateInstruccion(id=5, path_video='4_entre_dedos.mp4', time=TIEMPO_POR_INSTRUCCION)  )
INSTRUCCIONES.append(  CreateInstruccion(id=6, path_video='7_detras_dedos.mp4', time=TIEMPO_POR_INSTRUCCION)  )
INSTRUCCIONES.append(  CreateInstruccion(id=7, path_video='6_pulgares.mp4', time=TIEMPO_POR_INSTRUCCION)  )
INSTRUCCIONES.append(  CreateInstruccion(id=8, path_video='8_unas.mp4', time=TIEMPO_POR_INSTRUCCION)  )
INSTRUCCIONES.append(  CreateInstruccion(id=9, path_video='9_munecas.mp4', time=TIEMPO_POR_INSTRUCCION)  )
INSTRUCCIONES.append(  CreateInstruccion(id=10, path_video='10_enjuagarSecar.mp4', time=TIEMPO_POR_INSTRUCCION)  )
